...
namespace theme_apas\output\core;
...
class course_renderer extends \core_course_renderer {
    ...
    public function include_frontslide_js($blockid) {
        $this->page->requires->js_call_amd('theme_apas/frontpage', $blockid, []);
    }
...
public function render_news_items_html() {
    ...
    public function frontpage_available_courses() {
        global $CFG;
        $displayoption = theme_apas_get_setting('availablecoursetype');
        if ($displayoption != '1') {
    ...
    public function render_template($template, $data) {
        ...
        return $this->output->render_from_template('theme_apas/course_blocks', $data);
    }
    ...
    public function promoted_courses() {
        ...
        $pcoursestatus = theme_apas_get_setting('pcoursestatus');
        $promotedtitle = theme_apas_get_setting('promotedtitle', 'format_html');
        $promotedtitle = theme_apas_lang($promotedtitle);
        $promotedcoursedesc = theme_apas_lang(theme_apas_get_setting('promotedcoursedesc'));
        $featuredids = theme_apas_get_setting('promotedcourses');
        ...
        if (!empty($featuredids)) {
            ...
            $helperobj = new \theme_apas\helper();
        ...
        return $this->output->render_from_template("theme_apas/course_blocks", $template);
    }
    ...
    public function frontpage() {
        ...
        $output = '';
        $themeblocks = new \theme_apas\apas_blocks();
        ...
        $apasfrontpagelayout = array_merge($beforelayout, $frontpagelayout, $afterlayout);
        foreach ($apasfrontpagelayout as $a) {
            switch($a) {
    ...
    protected function coursecat_category(\coursecat_helper $chelper, $coursecat, $depth) {
        ...
        $combolistboxtype = (theme_apas_get_setting('comboListboxType') == 1) ? true : false;
        if ($combolistboxtype) {
            $classes[] = 'collapsed';
        }
    ...
    public function render_my_courses_home() {
        ...
        return $this->output->render_from_template('theme_apas/my_courses_home', ['courses' => $coursedata]);
    }
