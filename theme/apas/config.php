...
$THEME->csspostprocess = 'theme_apas_process_css';
...
$THEME->scss = function($theme) {
    return  theme_apas_get_main_scss_content($theme);
};
$THEME->prescsscallback = 'theme_apas_get_pre_scss';

$THEME->extrascsscallback = 'theme_apas_get_extra_scss';
