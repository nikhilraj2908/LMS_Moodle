...
// Promoted Courses.
$temp = new admin_settingpage('theme_apas_promotedcourse', get_string('promotedcoursesheading', 'theme_apas'));

// Promoted Courses Heading.
$name = 'theme_apas_promotedcoursesheading';
$heading = get_string('promotedcoursesheading', 'theme_apas');
$information = '';
$setting = new admin_setting_heading($name, $heading, $information);
$temp->add($setting);

// Enable / Disable option for Promoted Courses.
$name = 'theme_apas/pcoursestatus';
...
$name = 'theme_apas/promotedtitle';
$title = get_string('title', 'theme_apas');
$description = get_string('promotedtitledesc', 'theme_apas');
$default = 'lang:promotedtitledefault';
$setting = new admin_setting_configtext($name, $title, $description, $default);
$temp->add($setting);

// Promoted courses block description.
$name = 'theme_apas/promotedcoursedesc';
...
// Promoted courses.
$name = 'theme_apas/promotedcourses';
$title = get_string('pcourses', 'theme_apas');
$description = get_string('pcoursesdesc', 'theme_apas');
$default = [];
$courses[0] = '';
$cnt = 0;
