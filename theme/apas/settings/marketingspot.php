...
// Marketing Spot.
$temp = new admin_settingpage('theme_apas_marketingspot', get_string('mspotheading', 'theme_apas'));

// Marketing Spot heading.
$name = 'theme_apas_mspotheading';
$heading = get_string('mspotheading', 'theme_apas');
$information = '';
$setting = new admin_setting_heading($name, $heading, $information);
$temp->add($setting);

// Enable or disable option for marketing spot .
$name = 'theme_apas/mspotstatus';
...
$name = 'theme_apas/mspotcontent';
$title = get_string('content', 'theme_apas');
$description = get_string('content_desc', 'theme_apas');
$default = get_string('mspotdesc', 'theme_apas');
$setting = new admin_setting_confightmleditor($name, $title, $description, $default);
$temp->add($setting);

// Marketing Spot Media.
$name = 'theme_apas/mspotmedia';
$title = get_string('media', 'theme_apas');
$description = get_string('mspotmedia_desc', 'theme_apas');
