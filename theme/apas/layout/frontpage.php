...
$PAGE->requires->css(new moodle_url('/theme/apas/style/slick.css'));
$PAGE->requires->js_call_amd('theme_apas/frontpage', 'init');

$bodyattributes = $OUTPUT->body_attributes($extraclasses);

// Jumbotron class.
$jumbotronclass = (!empty(theme_apas_get_setting('jumbotronstatus'))) ? 'jumbotron-element' : '';

// Default Course Image
$default_image_url = $CFG->wwwroot . '/theme/apas/pix/defaultcourse.jpg';
...
if (isloggedin() && !isguestuser()) {
    ...
    $templatecontext['alert_gif'] = $OUTPUT->image_url('alert', 'theme_apas')->out(false);
...
$templatecontext['sitefeatures'] = (new \theme_apas\apas_blocks())->sitefeatures();

$templatecontext['banners'] = [
    [
        'image_url' => $OUTPUT->image_url('banner1', 'theme_apas')->out(),
    ...
    [
        'image_url' => $OUTPUT->image_url('banner2', 'theme_apas')->out(),
    ...
    [
        'image_url' => $OUTPUT->image_url('banner3', 'theme_apas')->out(),
...
echo $OUTPUT->render_from_template('theme_apas/frontpage', $templatecontext);
