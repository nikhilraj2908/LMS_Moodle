...
$string['allstudentsreport'] = 'All Students Module Completion Report';
$string['exportcsv'] = 'Export (CSV)';
$string['exportexcel'] = 'Export (Excel)';

$string['form_order_dir_asc'] = 'Ascending';
$string['form_order_dir_desc'] = 'Descending';
$string['allstudentsreport'] = 'All Students Module Completion Report';
$string['alluserallcourses'] = 'All user all courses';
$string['form_starting_date'] = 'Starting date';
$string['form_ending_date'] = 'Ending date';
$string['orderedby'] = 'Ordered By';
$string['direction'] = 'Direction';
$string['form_order_by_student'] = 'Student';
$string['form_order_by_completion'] = 'Completion Date';
$string['form_order_by_last_completed'] = 'Last Completed Module';
$string['form_order_dir_asc'] = 'Ascending';
$string['form_order_dir_desc'] = 'Descending';
$string['exportcsv'] = 'Export (CSV)';
$string['exportexcel'] = 'Export (Excel)';
$string['max_percentage_achieved'] = 'Maximum percentage achieved by a student';
$string['number_of_results'] = 'Number of results';
$string['last_module_completion'] = 'Last module completion date';
$string['show_all'] = 'Show All';